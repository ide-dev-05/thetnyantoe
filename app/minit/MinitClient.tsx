...
export const metadata: Metadata = {
  title: "miniT — AI Assistant",
  description:
    "miniT is an interactive AI assistant created by Thet Nyan Toe, showcasing AI-powered UI and conversational experiences.",
  alternates: {
    canonical: "https://www.thetnyantoe.site/minit",
  },
};
export default function miniTClient() {
      ...
      <section className="h-screen w-full flex justify-center pt-[50px] md:pt-[80px] overflow-hidden bg-[#ddddd1] dark:bg-[#000b0a]">
        <div className="flex flex-col justify-between w-full h-full min-h-0 max-w-[750px] pb-[5px] sm:pb-[20px] px-[5px]">
                  ...
                  <div className="max-w-[80%]">
                    {m.role === "assistant" && (
                      <div className="flex items-center mb-[-10px]">
                        <Image
                          src="https://res.cloudinary.com/dtwvkmuje/image/upload/v1766777767/cato_k9jyux.gif"
                          width={100}
                          height={100}
                          alt="miniTnt"
                          className="size-[50px]"
          ...
          >
            {input ? (
              <Image
                src="https://res.cloudinary.com/dtwvkmuje/image/upload/v1766777764/cato2_nhqf5i.gif"
                width={30}
                height={30}
                alt="mini"
              ...
              <Image
                src="https://res.cloudinary.com/dtwvkmuje/image/upload/v1766777766/cato3_dhmokc.gif"
                width={30}
                height={30}
                alt="mini"
